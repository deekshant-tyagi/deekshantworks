        ...
        <div className="container mx-auto px-4 md:px-8 flex justify-between items-center">
          ...
          {isMobile ? (
            <button 
              ...
              className="cursor-hover text-white"
        ...
        <div className="fixed inset-0 z-50 flex">
          ...
          <div className="absolute right-0 top-0 h-full w-[80%] max-w-sm bg-ayush-black transform transition-transform duration-300 ease-in-out animate-slide-in-right">
            <div className="p-6 flex justify-between items-center border-b border-gray-800">
              ...
              <button 
                onClick={() => setMobileMenuOpen(false)}
                className="text-ayush-teal hover:text-white transition-colors"
            ...
            <div className="flex-1 p-6">
              <ul className="flex flex-col space-y-6">
                <li>
                  <a 
                    href="#" 
                    className="block py-3 px-4 text-lg font-medium bg-ayush-teal text-white rounded-md"
                    onClick={(e) => {
                      e.preventDefault();
                ...
                <li>
                  <a 
                    href="#work" 
                    className="block py-3 px-4 text-lg text-white hover:text-ayush-teal transition-colors"
                    onClick={() => setMobileMenuOpen(false)}
                  >
                    Work
                  </a>
